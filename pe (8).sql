...
INSERT INTO `trial` (`id_trial`, `tanggal`, `jam_start`, `jam_finish`, `mc_name`, `trial`, `kapasitas`, `cush_prec`, `pin_cus_qtt`, `die_height`, `die_dim`, `problem_tool`, `analisa_sebab_tool`, `counter_measure_tool`, `problem_part`, `analisa_sebab_part`, `counter_measure_part`, `PIC`, `target`, `keterangan`, `kelengkapan_dies`, `accuracy_part`, `id_proses`, `id_part`, `id_customer`, `qty_trial`, `jumlah_ok`, `jumlah_ng`, `visual`, `dimensi`, `fungsi`, `judgement`, `dibuat`, `diperiksa`, `diketahui`, `peserta`) VALUES
(10, '2025-03-13', '12:00', '14:00', '123', '', '123', '0', '0', '0', '0', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '0', 1, 18, 1, '100', '100', '100', 'OK', 'OK', 'OK', 'OK', '-', '-', '-', 'TONO'),
(11, '2025-03-13', '11:04', '23:03', '123', '', '12', '12', '12', '12', '12', '12', '12', '12', '12', '21', '12', '122', '12', '12', '12', '12', 1, 18, 1, '12', '12', '12', 'OK', 'OK', 'OK', 'OK', '12', '12', '12', '12'),
(12, '2025-03-12', '11:11', '14:11', 'YASHINO MP038', '10', '100', '11', '11', '11', '12', '123', 'LAMPU MATI', 'TUNGGU LISTRIK NYALA', '123', '123', '12', '123', 'BESOK', '213', '21', '122', 1, 18, 1, '12', '12', '12', 'OK', 'OK', 'OK', 'OK', 'TONO', 'TONO', 'TONO', 'TONO'),
(13, '2025-03-13', '10:00', '13:00', 'YASHINO MP038', '10', '100', '0', '0', '328', '0', 'Burry', 'Dies kurang minyak', 'Diberi minyak', '-', '-', '-', '-', '-', '-', '98%', '0', 1, 18, 1, '100', '90', '10', 'OK', 'OK', 'OK', 'OK', 'Jono', 'Jono', 'Jono', 'Jono');
...
--
ALTER TABLE `trial`
  MODIFY `id_trial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
