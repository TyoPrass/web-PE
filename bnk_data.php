<?php
include_once('../../Database/koneksi.php'); // Include your database connection
session_start();
...
<!-- Mirrored from coderthemes.com/hyper/saas/apps-projects-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jul 2022 10:21:08 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-12">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form action="tambah_part.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3 position-relative" id="datepicker1">
                                                    ...
                                                    <input type="text" name="startdate" class="form-control" data-provide="datepicker" data-date-container="#datepicker1" data-date-format="d-M-yyyy" data-date-autoclose="true">
                                                </div>
                                            </div>
                                            <div class="col-xl-6">
                                                <div class="mb-3 mt-3 mt-xl-0">
                                                    <label for="projectname" class="mb-0">Gambar Part</label>
                                                    <div class="fallback">
                                                        <input name="file" type="file" />
                                                    </div>
                                                    <div class="dz-message needsclick">
                                                        <i class="h3 text-muted dripicons-cloud-upload"></i>
                                                        <h4>Drop File Disini Untuk Gambar.</h4>
                                                    </div>
                                                </div>
                                                <div class="mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Due Date</label>
                                                    <input type="text" name="duedate" class="form-control" data-provide="datepicker" data-date-container="#datepicker2" data-date-format="d-M-yyyy" data-date-autoclose="true">
                                                </div>
                                            </div>
                                        </div>
