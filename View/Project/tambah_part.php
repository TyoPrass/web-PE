                            ...
                            <div class="col-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if (!isset($_GET['edit']) && !isset($_GET['insert'])): ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = $result->fetch_assoc()): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <a href="tambah_part.php?edit=<?php echo $row['id_part']; ?>" 
                                                                       class="btn btn-info btn-sm" 
                                                                       data-bs-toggle="tooltip" 
                                                                       title="Edit">
                                                                        <i class="mdi mdi-pencil"></i>
                                                                    </a>
                                                                    <a href="tambah_part.php?delete=<?php echo $row['id_part']; ?>" 
                                        ...
                                        <div class="mt-3">
                                            <a href="tambah_part.php?insert=true" class="btn btn-success">
                                                <i class="mdi mdi-plus"></i> Insert New Record
                                            </a>
                                        </div>
                                    <?php else: ?>
                                        <!-- Insert/Update Form -->
                                        <form id="dataForm" action="tambah_part.php" method="post" enctype="multipart/form-data">
        ...
        Dropzone.options.myAwesomeDropzone = {
            ...
            init: function() {
                ...
                myDropzone.on("successmultiple", function() {
                    window.location.href = 'tambah_part.php';
                });
